export const authErrors = {
    ...
    "auth/phone-number-already-exists": "The provided phoneNumber is already in use by an existing user",
    ...
    "auth/app-not-authorized": "This app, identified by the domain where it's hosted, is not authorized to use Firebase Authentication with the provided API key",
    ...
    "auth/dependent-sdk-initialized-before-auth": "Another Firebase SDK was initialized and is trying to use Auth before Auth is initialized",
    ...
    "auth/emulator-config-failed": "Auth instance has already been used to make a network call",
    ...
    "auth/invalid-user-token": "This user's credential isn't valid for this project",
    ...
    "auth/invalid-sender": "The email template corresponding to this action contains an invalid sender email or name",
    ...
    "auth/auth-domain-config-required": "Be sure to include authDomain when calling firebase",
    ...
    "auth/too-many-requests": "We have blocked all requests from this device due to unusual activity",
